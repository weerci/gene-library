...
{
    public partial class FormClassIkl : Form
    {
        // Constructors
        public FormClassIkl(Vocabulary dictionary)
        {
            InitializeComponent();
            this.vocabulary = (ClassIklVocabulary)dictionary;
        }
        public FormClassIkl(Vocabulary dictionary, int id)
            : this(dictionary)
        {
            this.IsEdit = true;
            this.id = id;
        ...
        // Events
        private void FormClassIkl_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        // Private members
        private int id;
        private ClassIklItem item;
        private ClassIklVocabulary vocabulary;
